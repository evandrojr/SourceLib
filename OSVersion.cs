...
namespace ShowLib
{
    public class OSVersion
    {
        ...
        /// </summary>
        /// <returns>Dictionary containing the name of the operating system, its service pack (if any) and architecture</returns>
        public static Dictionary<string, string> getOSInfo()
        {
            ...
            Dictionary<string, string> OSData = new Dictionary<string, string>();
            ...
            OSData.Add("OSVersion", osVersion);
            OSData.Add("OSServicePack", osServicePack);
            OSData.Add("OSArchitecture", OSArch.ToString());
            return OSData;
        }
